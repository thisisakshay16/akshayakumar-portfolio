...
export const gridItems = [
  {
    id: 1,
    title: "I’ve unlocked over 1500+ days in my IT journey, gaining hands-on experience across data analysis, business insights projects.",
  ...
  {
    id: 5,
    title: "Skilled in Business Reporting, processing structured data, automating repetitive workflows using tools like Power BI and Excel VBA & Data Automation",
   description: "",
  ...
  },
  {
    ...
    description: "Open, Ready, Reliable",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
